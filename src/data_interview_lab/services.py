...
from data_interview_lab.generation import ExerciseGenerationError, ExerciseGenerator
from data_interview_lab.grading.compare import compare_results
from data_interview_lab.llm import create_provider
...
def generate_advanced_progressively(
    ...
    *,
    ...
    with ThreadPoolExecutor(
        max_workers=2, thread_name_prefix="data-interview-lab-question"
    ) as pool:
        futures = {
            pool.submit(
