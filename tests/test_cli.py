...
def test_occupied_port_from_another_app_fails_clearly(monkeypatch) -> None:
    monkeypatch.setattr(cli, "_data_interview_lab_is_running", lambda _: False)
...
def test_health_check_rejects_stale_server_version(monkeypatch) -> None:
    ...
    assert cli._data_interview_lab_is_running("http://127.0.0.1:8765") is False
